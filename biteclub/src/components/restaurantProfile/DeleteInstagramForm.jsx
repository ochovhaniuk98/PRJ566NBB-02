  ...
  return (
    <div className="fixed w-screen h-screen bg-black/50 left-0 top-0 z-200 py-12 px-60">
      <div className={`box-border bg-white h-full w-full  rounded-lg  z-210 p-8 flex flex-col shadow-lg`}>
        ...
        <div className="w-full h-full bg-brand-blue-lite p-4 mt-4 rounded-lg overflow-y-scroll grid grid-cols-1 sm:grid-cols-2 gap-2 shadow-inner">
          {instagramEmbeds.length === 0 && (
            <div className="col-span-3 text-center text-gray-500">No Instagram embeds available to delete.</div>
          )}
          {instagramEmbeds.length > 0 &&
