...
// --- Icons ---
import { AlignCenterIcon } from '@/components/tiptap-rich-text-editor/tiptap-icons/align-center-icon';
import { AlignJustifyIcon } from '@/components/tiptap-rich-text-editor/tiptap-icons/align-justify-icon';
import { AlignLeftIcon } from '@/components/tiptap-rich-text-editor/tiptap-icons/align-left-icon';
import { AlignRightIcon } from '@/components/tiptap-rich-text-editor/tiptap-icons/align-right-icon';
