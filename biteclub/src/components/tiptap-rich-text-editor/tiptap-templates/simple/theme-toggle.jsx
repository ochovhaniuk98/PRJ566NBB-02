...
// --- Icons ---
import { MoonStarIcon } from '@/components/tiptap-rich-text-editor/tiptap-icons/moon-star-icon';
import { SunIcon } from '@/components/tiptap-rich-text-editor/tiptap-icons/sun-icon';
